...
let safe_area_x = (given_x: number) => {
    const image_width = useSelector(select_Image_Dimensions).y;
...
let safe_area_y = (given_y: number) => {
    const image_height = useSelector(select_Image_Dimensions).y;
